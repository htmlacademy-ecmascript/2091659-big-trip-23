...
function createFiltersListTemplate(filtersItems, currentFilterType) {
  const filtersListTemplate = filtersItems.map((filter) => createFilterItemTemplate(filter, currentFilterType)).join('');
  return (`
